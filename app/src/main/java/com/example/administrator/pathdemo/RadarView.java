...
public class RadarView extends View {
    ...
    private void drawText(Canvas canvas) {
        ...
        float fongHeight = fontMetrics.descent - fontMetrics.ascent;
        for(int i=0;i<count;i++){
            float x = (float) (centerX+(radius+fongHeight/2)*Math.cos(angle*i));
            float y = (float) (centerY+(radius+fongHeight/2)*Math.sin(angle*i));
